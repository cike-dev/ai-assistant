...
st.set_page_config(
    page_title="Wolvina AI Assistant",
    page_icon="🤖",
    layout="wide",
    initial_sidebar_state="expanded"
)

# Custom CSS to apply a clean look and ensure the chat container fills the space
st.markdown("""
    <style>
        ...
        /* Style for the main container holding the chat */
        .chat-container {
            ...
            padding: 0;
            overflow: hidden; /* Ensure rounded corners are maintained for the chat area */
        }
        /* Ensure the embedded iframe (for the widget) takes full space */
        iframe {
            border-radius: 12px;
        }
    </style>
...
# --- Custom Wolvina Chat UI HTML (Embedded Component) ---

# The full HTML content of wolvina_ai_assistant.html is placed here.
WOLVINA_CHAT_HTML = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Crucial for embedding: make the body fit the iframe height */
            height: 100vh; 
        }
...
<body class="h-full flex flex-col">
    ...
    <script>
        const RASA_SERVER_URL = "http://localhost:5005/"; // *** CHANGE THIS TO YOUR RASA ACTION SERVER URL ***
...
st.title("Streamlit Portal for Wolvina AI Assistant")
st.subheader("Embedding the Custom Chat Interface")

st.markdown("""
    <div class="chat-container">
    """, unsafe_allow_html=True)

# Embed the Custom HTML Chat UI using the HTML component
# We give it a substantial height (700px) to ensure the fixed header/footer
# elements within the HTML file are visible and the scrollable area works well.
components.html(
    WOLVINA_CHAT_HTML,
    height=700,
    scrolling=False
...
st.markdown("1. This Python file now contains your complete custom chat UI embedded as a string.")
st.markdown("2. Ensure the `RASA_SERVER_URL` variable inside the HTML string is updated to your live Rasa endpoint.")
st.markdown("3. Run the application using `streamlit run streamlit_rasa_app.py`.")