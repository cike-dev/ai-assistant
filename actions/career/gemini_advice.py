...
# Please provide me with tailored career advice, UK job market insights for 2025, and actionable next steps.
# """
...
#         if not final_text:
#             logger.info("GiveCareerAdvice: There's something wrong with the response text. Sampled response: {response[:20]} \n")
#             dispatcher.utter_message(text="I'm having trouble accessing updated career insights right now. Try again soon 😊.")
#             return []

#         logger.info("Career advice generated successfully.::: {final_text[:50]} ... \n")
